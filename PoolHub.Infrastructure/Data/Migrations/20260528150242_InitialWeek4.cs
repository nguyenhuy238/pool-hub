...
{
    /// <inheritdoc />
    public partial class InitialWeek4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PricingPlanRules",
                columns: table => new
                {
                    PricingPlanRuleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PricingPlanId = table.Column<int>(type: "int", nullable: false),
                    TableTypeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    BillingBlockMinutes = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingPlanRules", x => x.PricingPlanRuleId);
                    table.ForeignKey(
                        name: "FK_PricingPlanRules_PricingPlans_PricingPlanId",
                        column: x => x.PricingPlanId,
                        principalTable: "PricingPlans",
                        principalColumn: "PricingPlanId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PricingPlanRules_TableTypes_TableTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueTables", x => x.TableId);
                    table.ForeignKey(
                        name: "FK_VenueTables_TableTypes_TableTypeId",
                        column: x => x.TableTypeId,
                        principalTable: "TableTypes",
                        principalColumn: "TableTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VenueTables_Zones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionTableAssignments", x => x.AssignmentId);
                    table.ForeignKey(
                        name: "FK_SessionTableAssignments_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionTableAssignments_VenueTables_TableId",
                        column: x => x.TableId,
                        principalTable: "VenueTables",
                        principalColumn: "TableId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingPlanRules_PricingPlanId",
                table: "PricingPlanRules",
                column: "PricingPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PricingPlanRules_TableTypeId",
                table: "PricingPlanRules",
                column: "TableTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionTableAssignments_SessionId",
                table: "SessionTableAssignments",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionTableAssignments_TableId",
                table: "SessionTableAssignments",
                column: "TableId");

            migrationBuilder.CreateIndex(
                name: "IX_TableTypes_Code",
                table: "TableTypes",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueTables_PublicId",
                table: "VenueTables",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VenueTables_TableCode",
                table: "VenueTables",
                column: "TableCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VenueTables_TableTypeId",
                table: "VenueTables",
                column: "TableTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VenueTables_ZoneId",
                table: "VenueTables",
                column: "ZoneId");
