...
function accessForPath(pathname: string): RouteAccess {
  ...
  if (pathname.startsWith("/admin/discounts") || pathname.startsWith("/admin/payments")) return { roles: [ROLES.ADMIN, ROLES.CASHIER], permissions: [PERMISSIONS.PAYMENTS_MANAGE] };
